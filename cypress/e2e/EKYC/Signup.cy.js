...
describe('Launch URL', () => {
   ...
   s1.Click_Guardian_address_asmine();
    ...
    s1.Enter_percentage_share2(data.Percentage_share2);
    
    s1.Enter_Nominee2dob(data.Nominee2_dob);
    cy.wait(12000);
    s1.Enter_nominee2_address(data.Nominee2_address);
    s1.Enter_nominee2_pincode(data.Pincode);
    s1.Enter_nominee2_city(data.cityname);
    s1.Enter_nominee2_state(data.State);
    s1.Click_add_nominee3();
    
    //nominee3 details
    s1.Enter_nominee3_name(data.Nominee3_name);
    s1.Select_nominee3_relationship(data.Nominee3_relationship);
    s1.Enter_percentage_share3(data.Percentage_share3);
    
    s1.Enter_Nominee3_dob(data.Nominee3_dob);
    cy.wait(12000);
    s1.Enter_otherrelationship(data.OtherRelationship3);
  ...
  cy.fixture('signup').then((data)=>{
    ...
    s1.Click_delete(data.Delet_Reason);
